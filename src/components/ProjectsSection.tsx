...
const projects = [
  {
    ...
    description: "Crafted a vibrant, animated UX design for an artist-based platform where followers can download and learn songs and tabs, delivering an energetic, immersive experience that keeps musicians engaged. The design incorporates dynamic visuals and intuitive navigation.",
    role: "UX/UI Designer",
  ...
  },
  {
    ...
    description: "Designed a clean, professional, and minimal website focused on clarity and elegance, ensuring the brand's message comes through without distraction. The design emphasizes simplicity and usability, creating a seamless experience for visitors while maintaining a strong visual identity.",
    role: "UX/UI Designer",
